    ...
    <div className="h-[calc(100vh-8rem)]">
      <Card className="h-full grid grid-cols-1 md:grid-cols-[320px_1fr] overflow-hidden">
        <div className="border-r border-border">
          <div className="p-4 border-b border-border font-semibold">Client Conversations</div>
          <div className="p-2 space-y-2">
            {isLoading ? (
              ...
              <p className="p-4 text-muted-foreground">No client conversations yet.</p>
            ) : (
              conversations.map((conversation) => {
                ...
                return (
                  ...
                  >
                    <p className="font-medium">{conversation.userName || "Client"}</p>
